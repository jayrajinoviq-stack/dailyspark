...
import com.example.dailyspark.adapter.FolderQuoteAdapter
...
import com.example.dailyspark.databinding.DialogAddEditQuoteBinding
...
import com.example.dailyspark.viewmodel.FolderItemEvent
import com.example.dailyspark.viewmodel.FolderItemViewModel
...
//                  binding.tvEmptyState.visibility = if (count == 0) View.VISIBLE else View.GONE
    ...
    private fun shareQuote(quote: FolderQuoteEntity) {
        ...
        startActivity(android.content.Intent.createChooser(sendIntent, "Share quote via"))
    }
}
